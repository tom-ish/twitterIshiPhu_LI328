...
public class RetweetServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest requete, HttpServletResponse response) throws IOException{
		...
		String tweet = requete.getParameter("retweet");
		String srcID = requete.getParameter("from");
		
		// Traitement des donnees
		JSONObject json = ServicesTweet.reTweet(key, srcID, tweet, response.getWriter());
